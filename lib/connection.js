...
Connection.prototype._buildConnection = function _buildConnection(cb) {
    ...
    connectionOptions.slaveOk = this.config.slaveOk;
    ...
    connectionOptions.socketOptions = this.config.socketOptions;
    connectionOptions.autoReconnect = this.config.auto_reconnect;
    connectionOptions.disableDriverBSONSizeCheck = this.config.disableDriverBSONSizeCheck;
