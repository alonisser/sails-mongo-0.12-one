...
##This is a fork of sail-mongo 0.12 branch to allow me to use multiple sails-mongo adapters . Trying to solve a bug with sails mongo handling of multiple db with different options with different clusters
